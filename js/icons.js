...
(function () {
  ...
  var PATHS = {
    ...
    'i-close':     '<path d="M6.4 6.4l11.2 11.2M17.6 6.4 6.4 17.6"/>',
    'i-qr':        '<rect x="3.4" y="3.4" width="7" height="7" rx="1.5"/><rect x="13.6" y="3.4" width="7" height="7" rx="1.5"/><rect x="3.4" y="13.6" width="7" height="7" rx="1.5"/><path d="M13.6 13.6h3v3h-3zM19.2 13.6h1.4M13.6 19.2h3M19.2 18.4v2.2M20.6 20.6h-1.4"/>',
    'i-phone':     '<rect x="6.6" y="2.4" width="10.8" height="19.2" rx="2.4"/><path d="M10.4 5.4h3.2M11 18.4h2"/>',
    'i-download':  '<path d="M12 3.4v11.2M7.6 10.2 12 14.6l4.4-4.4M4.6 18.4v1.2a1.8 1.8 0 0 0 1.8 1.8h11.2a1.8 1.8 0 0 0 1.8-1.8v-1.2"/>',
    'i-ball':      '<circle cx="12" cy="12" r="8.8"/><path d="m12 7.4 3.9 2.8-1.5 4.6H9.6l-1.5-4.6z"/><path d="M12 3.4v4M19.5 9.8l-3.6 2.6M16.6 19.3l-2.2-4.5M7.4 19.3l2.2-4.5M4.5 9.8l3.6 2.6"/>',
    'i-racket':    '<ellipse cx="10.2" cy="9" rx="5.6" ry="6.4"/><path d="m13.6 13.9 5.6 6.5M8.6 4.2l3.2 9.6M6 7.4l8.4 4"/>',
    'i-dumbbell':  '<path d="M3.6 9.6v4.8M6.8 7v10M17.2 7v10M20.4 9.6v4.8M6.8 12h10.4"/>',
    'i-run':       '<circle cx="14.6" cy="4.7" r="2.2"/><path d="m7.6 21.2 2.6-5.4 3.4-2.2-1-4.6-3.2 1.8-2.2 3M13.2 13.6l3.2 2.2 1.4 5.4M12.6 9l3.8-1.2 2.8 2.6 2.2.6"/>',
    'i-chevron':   '<path d="M6 9.5 12 15.5l6-6"/>',
    'i-image':     '<rect x="3" y="5" width="18" height="14" rx="2.4"/><circle cx="8.6" cy="10" r="1.6"/><path d="m3.6 17.4 4.6-4.4 3.4 3.2 3.6-3.8 5.2 5"/>',
    'i-bike':      '<circle cx="5.6" cy="16.6" r="3.8"/><circle cx="18.4" cy="16.6" r="3.8"/><path d="M5.6 16.6 9.8 7.4h4.4l4 9.2M8.2 7.4h3.4M12.6 16.6h-3"/>',
    'i-boat':      '<path d="M3.4 15.6h17.2l-2.4 4.6a1.8 1.8 0 0 1-1.6 1H7.4a1.8 1.8 0 0 1-1.6-1Z"/><path d="M5.8 15.6V9.4l6.2-6v12.2M12 3.4l6.2 6v6.2"/>',
    'i-plc':       '<rect x="3.2" y="4.6" width="4.4" height="14.8" rx="1.2"/><rect x="9.8" y="4.6" width="4.4" height="14.8" rx="1.2"/><rect x="16.4" y="4.6" width="4.4" height="14.8" rx="1.2"/><path d="M5.4 7.4v.1M12 7.4v.1M18.6 7.4v.1M11 11h2.2M17.6 11h2.2M11 13.4h2.2M17.6 13.4h2.2"/>',
    'i-bolt':      '<path d="M13.4 2.8 5.6 13.4h5.4l-.4 7.8 7.8-10.6h-5.4Z"/>',
    'i-play':      '<circle cx="12" cy="12" r="8.8"/><path d="M10 8.4 16 12l-6 3.6Z"/>',
    'i-cube':      '<path d="M12 2.8 20.4 7.4v9.2L12 21.2 3.6 16.6V7.4Z"/><path d="m3.6 7.4 8.4 4.6 8.4-4.6M12 12v9.2"/>'
  };
